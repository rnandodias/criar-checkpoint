...
CARREIRAS_NIVEIS: Dict[str, Dict[int, List[int]]] = {
    ...
    "arquitetura_de_solucoes_com_ia": {
        1: [5738, 5739, 5741, 5742, 5743, 5744, 5745],
    },
    "cientista_de_dados": {
    ...
    "desenvolvimento_back_end_nodejs_v2": {
        2: [2324, 2360, 5128, 1887, 1930, 2675, 2790, 3156, 3661, 3362, 4136,
            4381, 5366],
        3: [4934, 4933, 5326, 5365, 5004, 5343, 5364, 5192, 5363],
    },
    "devops_engineering": {
    ...
    "engenharia_de_dados": {
        1: [5569, 5570, 3584, 5442, 5571, 3062, 3053, 5572, 5573, 5574, 5577,
            5579, 5580],
    },
    "engenharia_de_machine_learning": {
        1: [5393, 5394, 5395, 5803, 3054, 4857, 5804, 5389, 4807, 6120],
    },
    "engenharia_ia": {
    ...
    "especialista_ia_v2": {
        1: [5994, 5435, 5721, 5759, 5723, 5130, 5869],
        2: [4793, 5564, 4910, 4911, 5724, 5975, 3975, 5820],
        3: [5819, 5708, 4919, 4916, 4917, 4914]
    },
    "governanca_de_dados": {
        1: [3713, 4631, 4632, 3714, 4633, 3716, 4635, 3717, 5166, 4634],
        2: [4637, 3715, 5167, 5693, 4630, 5168, 5169, 5171, 5695, 5694],
        3: [5173, 5174, 5177, 5176, 5708, 5710, 5713, 5714, 5178, 5179],
    },
    "ia_aplicada_a_operacoes_e_infraestrutura": {
        1: [6397, 6421],
        2: [6386],
        3: [6431],
    },
    "ia_para_automacao_de_processos": {
        ...
        3: [5708, 5870, 5710, 5975, 6587, 5837],
    },
}
